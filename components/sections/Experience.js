...
export default function Experience() {
  ...
  return (
    <section className='tw-max-w-[1280px] tw-w-[90%] md:tw-w-[90%] lg:tw-w-full tw-mx-auto tw-my-10 md:tw-my-20'>
      <div className='tw-flex tw-relative tw-flex-col-reverse lg:tw-flex-row tw-items-center tw-justify-center tw-gap-6 lg:tw-h-[440px] xl:tw-h-[400px]'>
        {/* esquerda */}
        <div className='tw-relative tw-group tw-overflow-hidden tw-flex tw-items-center tw-w-full lg:tw-w-[60%] tw-px-6 tw-py-8 md:tw-py-10 lg:tw-py-6 tw-rounded-[30px] tw-border-t-2 tw-border-marrom tw-shadow-xl tw-h-full tw-bg-gradient-to-br tw-from-preto tw-to-cinza tw-z-20'>
          <div className='tw-opacity-[10%] group-hover:tw-opacity-[20%] tw-left-0 tw-z-0 tw-ease-linear tw-duration-300 tw-absolute tw-h-[50%] md:tw-h-full tw-w-full'>
            <Image
          ...
          <div className='tw-z-20 tw-flex tw-flex-col tw-items-center tw-w-full tw-gap-3 md:tw-flex-row lg:tw-items-start md:tw-justify-evenly'>
            <div className='tw-flex tw-flex-col'>
              <span className='tw-text-2xl tw-font-black tw-text-center tw-text-white'>{lang ? pt.pages.index.experiencia.DevWeb : en.pages.index.experiencia.DevWeb}</span>
              <div className="tw-grid tw-grid-cols-2 tw-py-2 tw-text-white tw-gap-y-4 md:tw-py-5 md:tw-px-2">
                {
                  tecnologies.map((t, i) => {
                    return (
                      <article className="tw-flex tw-items-center tw-justify-center tw-gap-2 md:tw-text-xl" key={i}>
                        {t.icon}
              ...
              <div className="tw-flex tw-items-center tw-justify-center">
                <a href="https://cursos.alura.com.br/user/marlon-beraldo/fullCertificate/880594ec4a2a3acf825a6af039d9c890"
                  className="tw-flex tw-items-center tw-gap-3 tw-text-sm tw-text-center tw-duration-300 tw-ease-out md:tw-text-base tw-text-marrom hover:tw-animate-none hover:tw-text-bege "
                  target="_blank"
                  rel="noreferrer"
                >
                  {lang ? pt.pages.index.experiencia.conferencia : en.pages.index.experiencia.conferencia} <MdOutlineKeyboardArrowRight className='left-bounce' />
                </a>
              </div>
            </div>
            <div className='tw-flex tw-flex-col tw-items-center tw-pt-5 md:tw-pt-0'>
              <span className='tw-text-2xl tw-font-black tw-text-center tw-text-white'>{lang ? pt.pages.index.experiencia.experiencia.titulo : en.pages.index.experiencia.experiencia.titulo}</span>
              <div className='tw-flex tw-flex-col tw-items-center tw-py-2 tw-text-center md:tw-py-5'>
        ...
        <div className='tw-w-full tw-min-h-[400px] md:tw-min-h-[350px] lg:tw-w-[25%] tw-flex tw-flex-col tw-items-center lg:tw-items-start tw-justify-center tw-rounded-[30px] lg:tw-border-t-2 tw-border-b-2 lg:tw-border-b-0 tw-border-marrom tw-shadow-xl tw-h-full tw-z-20 tw-bg-gradient-to-bl tw-from-preto tw-to-cinza '>
          <div className='tw-w-full tw-px-6 tw-py-8 md:tw-py-10 lg:tw-py-6'>
            <div className={`${exp === 'exp' ? "tw-block" : "tw-hidden"} tw-flex tw-flex-col tw-items-center lg:tw-items-start`}>
              ...
              <h1 className='tw-mb-3 tw-text-2xl tw-font-black tw-text-white'>{lang ? pt.pages.index.experiencia.MinhaExperiencia : en.pages.index.experiencia.MinhaExperiencia}</h1>
              <p className='tw-text-base tw-leading-[110%] tw-text-center lg:tw-text-start md:tw-w-[90%] lg:tw-w-full tw-min-h-[220px] md:tw-min-h-[160px] lg:tw-min-h-[210px]'>{lang ? pt.pages.index.experiencia.texto : en.pages.index.experiencia.texto}</p>
            </div>
            <div className={`${exp === 'quali' ? "tw-block" : "tw-hidden"} tw-flex tw-flex-col tw-items-center lg:tw-items-start`}>
              ...
              <h1 className='tw-mb-3 tw-text-2xl tw-font-black tw-text-white'>{lang ? pt.pages.index.experiencia.qualificacao : en.pages.index.experiencia.qualificacao}</h1>
              <p className='tw-text-base tw-leading-[110%] tw-text-center lg:tw-text-start md:tw-w-[90%] lg:tw-w-full tw-min-h-[220px] md:tw-min-h-[160px] lg:tw-min-h-[210px]'>{lang ? pt.pages.index.experiencia.tecnologias : en.pages.index.experiencia.tecnologias}</p>
            </div>
            <div className={`${exp === 'cont' ? "tw-block" : "tw-hidden"} tw-w-full tw-flex tw-flex-col tw-items-center lg:tw-items-start`}>
              ...
              <h1 className='tw-mb-3 tw-text-2xl tw-font-black tw-text-white'>{lang ? "Contato" : "Contact"}</h1>
              <div className='tw-flex tw-flex-col tw-items-center lg:tw-items-start tw-gap-2 tw-leading-[110%] tw-text-center lg:tw-text-start md:tw-w-[90%] lg:tw-w-full tw-min-h-[220px] md:tw-min-h-[160px] lg:tw-min-h-[210px]'>
                ...
                <p className='tw-flex tw-flex-col tw-items-center tw-w-full tw-gap-2 tw-mt-10 tw-text-sm tw-text-center md:tw-mt-4 lg:tw-mt-10'>
                  {lang ? "Ou se preferir, mande uma mensagem" : "Or if you prefer, send a message"}
                  <Link href="#contato" className='tw-text-white botao'>{lang ? "Contato" : "Contact"}</Link>
                </p>
              </div>
            </div>
          </div>
