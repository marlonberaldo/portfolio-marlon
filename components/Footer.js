...
export default function Footer() {
  ...
  return (
    <div className="tw-max-w-[1280px] tw-w-[90%] lg:tw-w-full tw-mx-auto tw-flex tw-flex-col tw-items-center">
      ...
      <footer className="tw-w-full tw-flex md:tw-flex-row tw-items-center tw-justify-between tw-text-gray-400 tw-border-gray-400 tw-px-5 tw-py-3 md:tw-py-5 tw-border-t-2">
